...
{
    public class BusinessPitchRepository : Repository<BusinessPitch>, IBusinessPitchRepository
    {
        public BusinessPitchRepository(IMSBackendContext _DbContext) : base(_DbContext)
        {
        }
    }
}
